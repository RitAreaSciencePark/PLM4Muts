...
INFILE_TEST="datasets/standard/test/MSA_databases/db_ssym.csv"
OUTFILE_TEST="datasets/standard/test/MSA_3Di_databases/tb_ssym.csv"
...
OMP_NUM_THREADS=128 torchrun --standalone  --nnodes 1 --nproc_per_node 8 --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $head_node_ip:29500 src/ProstT5TranslationDDP.py --input_file  ${INFILE_TEST} --output_file ${OUTFILE_TEST}
