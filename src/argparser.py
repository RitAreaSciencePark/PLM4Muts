...
def argparser_trainer():
    ...
    parser.add_argument("--dataset_dir",   default='datasets/S1827',             type=str,   help="Dataset dir")
...
def argparser_translator():
    parser = argparse.ArgumentParser()
    parser.add_argument("--input_file",  default='datasets/S1827/train/databases/db_train.csv', type=str,  help="In")
    parser.add_argument("--output_file", default='datasets/S1827/train/translated_databases/tb_train.csv', type=str, help="Out")
    args = parser.parse_args()
    return args
