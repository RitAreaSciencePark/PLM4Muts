...
def argparser_trainer():
    ...
    parser.add_argument("Path",   default=os.getcwd() + "/config.yaml", type=str,   help="Either Configuration file or Dataset directory")
...
def argparser_tester():
    parser = argparse.ArgumentParser(
                    ...
                    epilog='',
                    formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("--config_file",default=os.getcwd() + "/config.yaml", type=str,help="Configuration file")
...
def argparser_translator():
    parser = argparse.ArgumentParser(
                    ...
                    epilog='Text at the bottom of help') # FIXME
    parser.add_argument("--seeds",       default=[10,11,12], type=list,  help="List of three integers for random seeds")
...
def load_config(confir_file):
    with open(confir_file, "r") as file:
        try:
